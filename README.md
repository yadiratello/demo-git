...
HitHub es una plataforma en el cual vamos a poder subir gracias a GIT nuestros repositorios y de esta manera poder compartir nuestros proyectos.
...
y escribo una descripcion de mis cambios y doy click en "Create pull request" y me saldra un mensaje indicando que no tendre ningun tipo de problema con la rama principal.
